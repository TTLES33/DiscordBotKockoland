...
$sql = "SELECT * FROM KOCKOLAND_STATS WHERE id='6'";
...
$sql = "SELECT * FROM KOCKOLAND_STATS WHERE id='7'";
...
$sql = "SELECT * FROM KOCKOLAND_STATS WHERE id='8'";
...
$sql = "SELECT * FROM KOCKOLAND_STATS WHERE id='9'";
